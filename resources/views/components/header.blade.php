  ...
  <nav class="navbar flex-nowrap p-0">
	...
	<div class="header-content col px-md-3">
	  <div class="d-flex align-items-center">
		...
		<div class="dropdown mx-6 dropdown ml-2">
		
		  <a id="profileMenuInvoker" class="header-complex-invoker" href="#" aria-controls="profileMenu" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-target="#profileMenu" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-animation-in="fadeIn" data-unfold-animation-out="fadeOut"> 
		  <span class="unfold-item-icon mr-3"><i class="gd-user"></i></span>{{ Auth::user()->name }} <span class="caret"></span>
		  ...
		  <ul id="profileMenu" class="unfold unfold-user unfold-light unfold-top unfold-centered position-absolute pt-2 pb-1 mt-4 unfold-css-animation unfold-hidden fadeOut" aria-labelledby="profileMenuInvoker" style="animation-duration: 300ms;">
			...
			<!-- Authentication Links -->
				...
				<li class="unfold-item">
				<a class="unfold-link d-flex align-items-center text-nowrap" href="{{ route('register') }}">
					<span class="unfold-item-icon mr-3">
					<i class="gd-user"></i>
					</span>
					{{ __('Register') }}
				...
				@can('Manage-user')
				<li class="unfold-item">
				<a class="unfold-link d-flex align-items-center text-nowrap" href="{{ route('users.index') }}">Manage Users</a>
				</li>
				@endcan
				@can('Manage-role')
				<li class="unfold-item">
				<a class="unfold-link d-flex align-items-center text-nowrap" href="{{ route('roles.index') }}">Manage Role</a>
				</li>
				@endcan
				@can('Manage-order')
				<li class="unfold-item">
				<a class="unfold-link d-flex align-items-center text-nowrap" href="{{ route('orders.index') }}">Manage Order</a>
				</li>	
				@endcan	
				@can('Manage-service')
				<li class="unfold-item">
				<a class="unfold-link d-flex align-items-center text-nowrap" href="{{ route('orders.index') }}">Manage Service</a>
				</li>	
				@endcan	
			<li class="unfold-item unfold-item-has-divider">
			  <a class="unfold-link d-flex align-items-center text-nowrap" href="logout" onclick="event.preventDefault();
